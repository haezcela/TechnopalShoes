...
public class ItemDAO extends DAOBase {
	...
	public void add(Connection conn, List<PreparedStatement> prepStmntList, DTOBase obj) {
        ...
        try {
            ...
            prepStmnt.setString(8, item.getAddedBy());
            prepStmnt.setTimestamp(9, item.getAddedTimestamp());
            prepStmnt.setString(10, item.getUpdatedBy());
            prepStmnt.setTimestamp(11, item.getUpdatedTimestamp());
...
//    item.setAddedTimestamp(new java.sql.Timestamp(System.currentTimeMillis()));
//    item.setUpdatedBy("admin");
//    item.setUpdatedTimestamp(new java.sql.Timestamp(System.currentTimeMillis()));
//
//    executeAdd(item);
//}
