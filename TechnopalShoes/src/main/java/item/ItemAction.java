...
public class ItemAction extends ActionBase {
    ...
    protected void setSessionVars() {
        ...
        dataTable.setColumnNameArr(new String[] {"Code", "Category", "Name", "Description", "Unit", "Quantity", "Reorderpoint", "Actions"});
        dataTable.setColumnWidthArr(new String[] {"10","20", "10", "10", "20", "15","10", "15"}); 
